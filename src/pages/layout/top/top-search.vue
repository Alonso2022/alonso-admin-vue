<template>
  <el-autocomplete class="top-search"
    ...
    <template slot-scope="{ item }">
      <i class="iconfont" :class="[item[iconKey],'icon']"></i>
...
export default {
  ...
  computed: {
    labelKey () { return this.website.menuProps.label  },
    pathKey () { return this.website.menuProps.path },
    iconKey () { return this.website.menuProps.icon },
    childrenKey () { return this.website.menuProps.children },
